...
//ol.proj.get("EPSG:32749").setExtent([682326.708353, 9175654.076394, 700002.491341, 9210359.530197]);
var wms_layers = [];
...
var lyr_union_1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'union<br />\
    <img src="styles/legend/union_1_0.png" /> 1,2km (15 menit)<br />\
    <img src="styles/legend/union_1_1.png" /> 2,4km (30 menit)<br />\
    <img src="styles/legend/union_1_2.png" /> <br />' });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_union_1.setVisible(true);lyr_univ_surabaya_2.setVisible(true);lyr_PTNdiSurabaya_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_union_1,lyr_univ_surabaya_2,lyr_PTNdiSurabaya_3];
...
lyr_union_1.set('fieldImages', {'fid': 'TextEdit', 'Access': 'TextEdit', });
...
lyr_union_1.set('fieldLabels', {'fid': 'hidden field', 'Access': 'header label - always visible', });
lyr_univ_surabaya_2.set('fieldLabels', {'fid': 'hidden field', 'Nama': 'inline label - always visible', 'Kampus': 'inline label - always visible', 'Deskripsi Univ_QS WUR': 'inline label - always visible', 'Deskripsi Univ_Didirikan': 'inline label - always visible', 'Deskripsi Univ_Fakultas': 'inline label - always visible', });
lyr_PTNdiSurabaya_3.set('fieldLabels', {'fid': 'hidden field', 'Nama': 'inline label - always visible', 'Kampus': 'inline label - always visible', 'Rangking QS WUR': 'inline label - always visible', 'Tahun berdiri': 'inline label - always visible', 'Fakultas': 'inline label - always visible', 'Foto': 'inline label - always visible', });
